...
def main() -> None:
    ...
    ds_file = config.experiment.get("deepspeed_file", "1_node_4_gpus_deepspeed_zero2")
    ...
    num_processes = config.experiment.get("num_processes_per_machine", None)
